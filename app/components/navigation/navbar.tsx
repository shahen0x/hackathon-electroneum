...
const Navbar: FC<NavbarProps> = () => {
	...
	return (
		<nav className={`fixed top-0 left-0 z-40 w-full h-14 px-2 py-2 flex items-center justify-between transition-all duration-300 border-b border-neutral-800
		...
		`}>
			...
			<div className="flex items-center gap-2">
				<Button variant={"secondary"} size={"icon"} className="hidden md:block">
					<a href="https://x.com/ElectroPlayFun" target="_blank" rel="noreferrer" className="flex items-center justify-center w-full h-full">
						<FaXTwitter size={16} />
					</a>
				</Button>
				<Button variant={"secondary"} size={"icon"} className="hidden md:block">
					<a href="https://t.me/electroplay" target="_blank" rel="noreferrer" className="flex items-center justify-center w-full h-full">
						<FaTelegram size={20} />
					</a>
				</Button>
