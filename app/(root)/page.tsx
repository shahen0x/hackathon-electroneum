...
export default async function Home() {
	...
	return (
		<div className="container space-y-6">
			...
			{/* BANNER */}
			<div className="bg-primary rounded-2xl p-6 lg:p-10 lg:flex items-center gap-12 lg:gap-24 bg-[url(/home-banner-mobile.png)] bg-no-repeat bg-right bg-contain xl:bg-[url(/banner.png)]">
				<h1 className="mb-6 lg:mb-0 text-2xl sm:text-3xl font-bold font-start2p">Compete,<br />Climb,<br />Conquer</h1>
